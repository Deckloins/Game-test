...
class Player {
  ...
  playerMovement() {
    if (keyIsDown(UP_ARROW) && this.playerY > 0) {
      this.playerY -= this.playerSpeed;
    } else if (keyIsDown(DOWN_ARROW) && this.playerY + this.playerSize < 400) {
      this.playerY += this.playerSpeed;
    } else if (keyIsDown(LEFT_ARROW) && this.playerX > 0) {
      this.playerX -= this.playerSpeed;
    } else if (keyIsDown(RIGHT_ARROW) && this.playerX + this.playerSize < 400) {
      this.playerX += this.playerSpeed;
    }
  }
}
